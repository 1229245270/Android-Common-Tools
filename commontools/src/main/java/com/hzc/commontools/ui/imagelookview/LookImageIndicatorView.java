...
public class LookImageIndicatorView extends View implements ViewPager.OnPageChangeListener{
    ...
    public LookImageIndicatorView(Context context) {
        this(context, null);
    }
    public LookImageIndicatorView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public LookImageIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
